...
// GP_subproject_first.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CGPsubprojectfirstApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CGPsubprojectfirstApp::OnAppAbout)
END_MESSAGE_MAP()


// CGPsubprojectfirstApp 생성

CGPsubprojectfirstApp::CGPsubprojectfirstApp() noexcept
{
	// TODO: 아래 애플리케이션 ID 문자열을 고유 ID 문자열로 바꾸십시오(권장).
	// 문자열에 대한 서식: CompanyName.ProductName.SubProduct.VersionInformation
	SetAppID(_T("GPsubprojectfirst.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CGPsubprojectfirstApp 개체입니다.

CGPsubprojectfirstApp theApp;
...
int CGPsubprojectfirstApp::ExitInstance()
{
...
void CGPsubprojectfirstApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
