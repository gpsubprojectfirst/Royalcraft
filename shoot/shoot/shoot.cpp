...
// shoot.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CshootApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CshootApp::OnAppAbout)
END_MESSAGE_MAP()


// CshootApp 생성

CshootApp::CshootApp() noexcept
{
	// TODO: 아래 애플리케이션 ID 문자열을 고유 ID 문자열로 바꾸십시오(권장).
	// 문자열에 대한 서식: CompanyName.ProductName.SubProduct.VersionInformation
	SetAppID(_T("shoot.AppID.NoVersion"));
...
CshootApp theApp;
DWORD CshootApp::PrevTick = 0;
bool CshootApp::bRender = false;

// CshootApp 초기화
ULONG_PTR gpToken;
BOOL CshootApp::InitInstance()
{
...
UINT CshootApp::funcThread(LPVOID pParam)
{
	while (1)
	{
